...
#    Updated: 2025/03/03 23:28:05 by ynihei           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= $(addprefix $(SRCS_DIR)/, main.c error.c exec.c destructor.c parse.c signal.c pipe.c) \
			  ...
			  $(addprefix $(TOKENIZE_DIR)/, tokenize.c tokenize_helper.c)
